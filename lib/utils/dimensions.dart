...
//dynamic width for padding and margin
  ...
  //for images
  static double image = (screenWidth-(3*width20))/5;
  static double imageMargin = width20/4;
  ...
  static double font19 = screenHeight/47.3;
  static double font18 = screenHeight/53.0;
  static double font16 = screenHeight/60.0;
