...
const List<Choice> choices = <Choice>[
  ...
  Choice(title: 'Senorita WX', price: '₹ 32,000', icon: "assets/icons/washing-machine4.png"),
  Choice(title: 'Senorita ZXS', price: '₹ 36,550', icon: "assets/icons/washing-machine5.png"),
  Choice(title: 'Senorita TL-SSDB 7.5Kg', price: '₹ 22,990', icon: "assets/icons/washing-machine2.png"),
  Choice(title: 'Senorita WX', price: '₹ 32,000', icon: "assets/icons/washing-machine3.png"),
  Choice(title: 'Senorita WX', price: '₹ 32,000', icon: "assets/icons/washing-machine.png"),
  Choice(title: 'Senorita ZXS', price: '₹ 36,550', icon: "assets/icons/washing-machine1.png"),
  Choice(title: 'Senorita TL-SSDB 7.5Kg', price: '₹ 22,990', icon: "assets/icons/washing-machine4.png"),
  Choice(title: 'Senorita WX', price: '₹ 32,000', icon: "assets/icons/washing-machine5.png"),
                   ...
                   GestureDetector(
                     onTap: (){
                       ...
                       Navigator.push(context, MaterialPageRoute(builder:
                         ...
                         return IndvProductScreen(title: choice.title,price: choice.price,); }
                       ),);
                     },
                     child: Card(
