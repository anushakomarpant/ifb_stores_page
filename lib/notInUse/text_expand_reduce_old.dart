...
class TextExpandReduceOld extends StatefulWidget {
  Color? color;
  final String text;
  final String text2;
  final String value;
  ...
  @override
  State<TextExpandReduceOld> createState() => _TextExpandReduceOldState();
}

class _TextExpandReduceOldState extends State<TextExpandReduceOld> {
