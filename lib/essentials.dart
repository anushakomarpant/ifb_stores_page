...
class Choice {
 ...
 List<Choice> choices = <Choice>[
  const Choice(title: 'Fabric Care', icon: Icons.home, img: "assets/newimages/fabric_care1.jpg"),
  const Choice(title: 'Machine Care', icon: Icons.contacts, img: "assets/newimages/fabric_care.jpg"),
  const Choice(title: 'Dish Care', icon: Icons.map, img: "assets/newimages/dishwasher.jpg"),
  const Choice(title: 'Kitchen Care', icon: Icons.phone, img: "assets/newimages/kitchen1.jpg"),
  const Choice(title: 'Kitchen Gadgets', icon: Icons.camera_alt, img: "assets/newimages/kitchen2.jpg"),
  const Choice(title: 'Accessories', icon: Icons.settings, img: "assets/newimages/kitchen3.jpg"),
];
