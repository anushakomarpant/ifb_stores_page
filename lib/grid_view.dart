...
import 'package:ifb_store/products/ac.dart';
import 'package:ifb_store/products/dryer.dart';
import 'package:ifb_store/products/front_loader.dart';
import 'package:ifb_store/products/microwave.dart';
import 'package:ifb_store/products/top_loader.dart';
        ...
        GestureDetector(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder:
              ...
              return ProductScreen(title: choice.title, listn: choice.list, screen: choice.screen);
                }
            //=> choice.screen
            ),);
          },
